import type { PreferencesCursors } from './PreferencesCursors.js';
import type { PreferencesFileHandling } from './PreferencesFileHandling.js';
import type { PreferencesGeneral } from './PreferencesGeneral.js';
import type { PreferencesGuidesGridsAndSlices } from './PreferencesGuidesGridsAndSlices.js';
import type { PreferencesHistory } from './PreferencesHistory.js';
import type { PreferencesInterface } from './PreferencesInterface.js';
import type { PreferencesNotifications } from './PreferencesNotifications.js';
import type { PreferencesPerformance } from './PreferencesPerformance.js';
import type { PreferencesTools } from './PreferencesTools.js';
import type { PreferencesTransparencyAndGamut } from './PreferencesTransparencyAndGamut.js';
import type { PreferencesType } from './PreferencesType.js';
import type { PreferencesUnitsAndRulers } from './PreferencesUnitsAndRulers.js';
