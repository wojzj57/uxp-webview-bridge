...
import type { CharacterStyle } from './text/CharacterStyle.js';
import type { ParagraphStyle } from './text/ParagraphStyle.js';
import type { TextWarpStyle } from './text/TextWarpStyle.js';
/**
