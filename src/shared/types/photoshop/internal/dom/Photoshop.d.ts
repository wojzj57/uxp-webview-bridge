...
import type { Action, ActionSet } from './Actions.js';
import type { Documents } from './collections/Documents.js';
import type { TextFonts } from './collections/TextFonts.js';
import type { ColorSampler } from './ColorSampler.js';
import type * as Constants from './Constants.js';
import type { Document } from './Document.js';
import type { Guide } from './Guide.js';
import type { Layer } from './Layer.js';
import type { LayerComp } from './LayerComp.js';
import type { PathPointInfo } from './objects/PathPointInfo.js';
import type { SolidColor } from './objects/SolidColor.js';
import type { SubPathInfo } from './objects/SubPathInfo.js';
import type { Tool } from './objects/Tool.js';
import type { Preferences } from './preferences/Preferences.js';
import type { Selection } from './Selection.js';
import type { DocumentCreateOptions } from './types/DocumentTypes.js';
...
export class Photoshop {
   ...
   * @minVersion 23.0
   */
  batchPlay: (commands: any, options: any) => Promise<Array<import('./CoreModules.js').ActionDescriptor>>;
  /**
