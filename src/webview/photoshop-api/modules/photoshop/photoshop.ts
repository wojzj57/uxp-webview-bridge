...
export function createPhotoshopNamespace(rpc: PhotoshopRpc): PhotoshopNamespace {
  ...
  return {
    ...
    get preferencesCursors() { return app.preferences.cursors; },
    get preferencesFileHandling() { return app.preferences.fileHandling; },
    get preferencesGeneral() { return app.preferences.general; },
    get preferencesGuidesGridsAndSlices() { return app.preferences.guidesGridsAndSlices; },
    get preferencesHistory() { return app.preferences.history; },
    get preferencesInterface() { return app.preferences.interface; },
    get preferencesNotifications() { return app.preferences.notifications; },
    get preferencesPerformance() { return app.preferences.performance; },
    get preferencesTools() { return app.preferences.tools; },
    get preferencesTransparencyAndGamut() { return app.preferences.transparencyAndGamut; },
    get preferencesType() { return app.preferences.type; },
    get preferencesUnitsAndRulers() { return app.preferences.unitsAndRulers; },
